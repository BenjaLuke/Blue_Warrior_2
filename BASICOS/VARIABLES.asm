...
AVANCE_BLOQUEADO:				#1										; 0 libre, 66 limite de stage, 150 limite de boss
...
SEMAFORO_LABERINTO: #1														;Controla la activacion de velocidad en el laberinto de fase 4 para sólo una vez

;cinemáticas
CINEMATICA_BLOQUE_ACTUAL:          #1
CINEMATICA_PARPADEO_CONTADOR:      #1
CINEMATICA_PARPADEO_ESTADO:        #1
CINEMATICA_PARPADEO_VECES:         #1
CINEMATICA_PARPADEO_ACTIVO:        #1
CINEMATICA_LATIDO_CONTADOR:        #1
CINEMATICA_LATIDO_INDICE:          #1
CINEMATICA_BANDERA_ESTADO:	#1
CINEMATICA_BANDERA_CONTADOR:	#1
CINEMATICA_NUBE_X:	#1
CINEMATICA_NUBE_CONTADOR:	#1
CINEMATICA_NUBE_ATRIBUTOS:	#40
CINEMATICA_NUBE_2_X:	#1
CINEMATICA_NUBE_2_CONTADOR:	#1
CINEMATICA_NUBE_2_ATRIBUTOS:	#40
CINEMATICA_NUBE_3_X:	#1
CINEMATICA_NUBE_3_CONTADOR:	#1
CINEMATICA_NUBE_3_ATRIBUTOS:	#16
CINEMATICA_NUBE_4_X:	#1
CINEMATICA_NUBE_4_CONTADOR:	#1
CINEMATICA_NUBE_4_ATRIBUTOS:	#16
CINEMATICA_NUBE_5_X:	#1
CINEMATICA_NUBE_5_CONTADOR:	#1
CINEMATICA_NUBE_5_ATRIBUTOS:	#16
CINEMATICA_NUBE_6_X:	#1
CINEMATICA_NUBE_6_CONTADOR:	#1
CINEMATICA_NUBE_6_ATRIBUTOS:	#16
CINEMATICA_NUBE_7_X:	#1
CINEMATICA_NUBE_7_CONTADOR:	#1
CINEMATICA_NUBE_7_ATRIBUTOS:	#16
CINEMATICA_COLOR_0_MODO:	#1
CINEMATICA_FINAL_CREDITOS_Y_ACTUAL_RAM:	#2
CINEMATICA_FINAL_CREDITOS_FRAMES_RAM:	#2
CINEMATICA_FINAL_CREDITOS_PAGE_RAM:	#1
MAPA_SITUACION_LEFT_X:	#1
MAPA_SITUACION_RIGHT_X:	#1
MAPA_SITUACION_BUFFER_PAGE:	#1
MAPA_SITUACION_LEFT_X_PAGE_0:	#1
MAPA_SITUACION_RIGHT_X_PAGE_0:	#1
