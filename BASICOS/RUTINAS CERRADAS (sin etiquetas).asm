...
;.PATRONES:
		...
		ld		a,(SPRITE_CAIDO)
		or		a
		jp		nz,PINTA_SPRITE_DEPH.MAS_COLORES
...
;.bucle_espera_vblank_real:
		...
		ld		a,(VBLANK_REAL)
		or		a
		jr		z,ESPERA_VBLANK_REAL.bucle_espera_vblank_real
		ret
...
;PARTE_B:
		...
		sub		26
		cp		5
		jr		nc,SIN_DANO_MAGIA_BOSS
		call	DANO_MAGIA_EN_AGONIX_BOSS_1
		jr		nz,SIN_DANO_MAGIA_BOSS
		...
		jp		MAGIA_MATA_ERRECENYX_BOSS_4
