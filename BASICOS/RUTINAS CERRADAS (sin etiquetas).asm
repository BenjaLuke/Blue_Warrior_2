...
;BUCLE_PINTA_TILES:
		...
		jp		z,BUCLE_PINTA_TILES.AVISAMO_FINAL_SCROLL									; Si se ha llegado al final se parará
...
;.A_PALETA_1:
		...
		call	PALETA_ESCOGIDA.COMUN_PALETAS_1												; Cambiamos la página del bloque 2													; Cambiamos la página del bloque 2	
...
;.ahora_la_musica:
		...
		ld		a,(MUSICA_BEST_ON)
		or		a
		jp		z,PALETA_ESCOGIDA.musica_normal

;.musica_inusual:

		ld		a,39
		jp		PALETA_ESCOGIDA.resolucion_musica
