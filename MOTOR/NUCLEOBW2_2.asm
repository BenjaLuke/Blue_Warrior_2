...
.MIRA_BLINDAJE_NACIMIENTO_ENEMIGO:
			...
			ld		a,(hl)
			cp		17
			jr		nc,.ENEMIGO_SI_BLINDADO_NACIMIENTO
			pop		af
			or		a
			ret
...
.CONTROL_TILES_PUPA_1:
			...
			jr		c,.HACEMOS_PUPA
			cp		59
			jr		nc,.CONTROL_TILES_PUPA_2
			ld		a,(FASE)
			cp		5
			jr		z,.CONTROL_TILES_PUPA_2
			ld		a,(TILE_CENTRO)
			jr		.HACEMOS_PUPA
...
.CONTROL_TILES_PUPA_2:
			...
			jr		c,.HACEMOS_PUPA
			cp		59
			jr		c,.MIRA_EXCEPCION_LETRAS_FASE_5
			cp		63
			jp		c,DEPH_PARALIZADO_2.CONTROL_DE_BLOQUEOS
			jr		nz,.HACEMOS_PUPA

.MIRA_EXCEPCION_LETRAS_FASE_5:
...
COLOR_SPRITES_VAGONETA_CAIDA_:
	...
	DB $00,$00,$00,$00,$00,$00,$00,$00
	DB $00,$00,$00,$00,$00,$00,$00,$00
PREPARA_DOBLE_BUFFER_PARA_MAGIA:

		ld		a,(PAGINA_DE_REGRESO)
		cp		28
		call	z,PREPARA_PAGE_2_PARA_MAGIA_BOSS_3
		ld		a,(PAGINA_DE_REGRESO)
		cp		29
		call	z,PREPARA_PAGE_2_PARA_MAGIA_BOSS_4
		ld		a,(PAGINA_DE_REGRESO)
		cp		30
		call	z,PREPARA_PAGE_2_PARA_MAGIA_BOSS_5
		jp		PARTE_A

RESTAURA_DOBLE_BUFFER_TRAS_MAGIA:

		ld		a,(PAGINA_DE_REGRESO)
		cp		28
		call	z,RESTAURA_PAGE_3_TRAS_MAGIA_BOSS_3
		ld		a,(PAGINA_DE_REGRESO)
		cp		29
		call	z,RESTAURA_PAGE_3_TRAS_MAGIA_BOSS_4
		ld		a,(PAGINA_DE_REGRESO)
		cp		30
		call	z,RESTAURA_PAGE_3_TRAS_MAGIA_BOSS_5
		ld		a,(MAGIAS)
		ret
