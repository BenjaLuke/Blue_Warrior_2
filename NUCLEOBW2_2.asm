...
SE_PUEDE_MOVER_Y_EFES_VARIOS:
			...
			jp		z,.PAUSE_VAGON
			bit		7,a											; Si pulsa f3 paramos la m鷖ica
...
.comun_covids_seguimos:
		...
		ld		hl,COLOR_COVID_1_1						; Damos color al sprite en la posici贸n de sprite que le toca	
		jp      TROZOS_COMUNES_9
...
; Hasta aqu铆, sustituyend el c贸digo anterior
...
.DEFINE_FIREWORKS:
		...
		ld		hl,COLOR_FIREWORKS						; Damos color al sprite en la posici贸n de sprite que le toca	
		jp      TROZOS_COMUNES_9
...
.COLOR_CORVELLINI_EN_STAGE_4:
		...
		pop		af
		ld		hl,COLOR_CORVELLINI_S4    				; Damos color al sprite en la posici贸n de sprite que le toca	
		jp      TROZOS_COMUNES_9

.COLOR_CORVELLINI_GENERAL:

		pop		af
		ld		hl,COLOR_CORVELLINI     				; Damos color al sprite en la posici贸n de sprite que le toca	
		jp      TROZOS_COMUNES_9
