...
FINAL_FASE_5_VAMOS_A_TERMINAR_ANCHO_BLOQUE:	equ	4
FINAL_FASE_5_VAMOS_A_TERMINAR_ALTO_BLOQUE:	equ	2
FINAL_FASE_5_VAMOS_A_TERMINAR_COLUMNAS:		equ	64
FINAL_FASE_5_VAMOS_A_TERMINAR_FILAS:		equ	106
FINAL_FASE_5_VAMOS_A_TERMINAR_SALTO_X:		equ	21
FINAL_FASE_5_VAMOS_A_TERMINAR_BYTES_HMMV:	equ	15
FINAL_FASE_5_VAMOS_A_TERMINAR_PAUSA_FILAS:	equ	#0400
...
FINAL_FASE_5_VAMOS_A_TERMINAR_PLANTILLA_HMMV:
		...
		db		FINAL_FASE_5_VAMOS_A_TERMINAR_ANCHO_BLOQUE,0
		db		FINAL_FASE_5_VAMOS_A_TERMINAR_ALTO_BLOQUE,0
		db		#00
		db		#00
...
FINAL_FASE_5_VAMOS_A_TERMINAR_INICIO:
		...
		ld		bc,FINAL_FASE_5_VAMOS_A_TERMINAR_BYTES_HMMV
		ldir
        
		ld		b,FINAL_FASE_5_VAMOS_A_TERMINAR_FILAS
...
.BUCLE_FILAS_FINAL_FASE_5:
		...
		ld		b,FINAL_FASE_5_VAMOS_A_TERMINAR_COLUMNAS
...
.BUCLE_COLUMNAS_FINAL_FASE_5:
		...
		ld		a,(FINAL_FASE_5_VAMOS_A_TERMINAR_X_SEED)
		add		a,FINAL_FASE_5_VAMOS_A_TERMINAR_SALTO_X
		and		00111111b
		ld		(FINAL_FASE_5_VAMOS_A_TERMINAR_X_SEED),a
		...
		push	bc
		ld		bc,FINAL_FASE_5_VAMOS_A_TERMINAR_PAUSA_FILAS
