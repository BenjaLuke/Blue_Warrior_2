VIDA_INICIAL_IDIUS_BOSS_5:					equ	156
...
COVID_BOSS_5_SPRITES_ACTIVOS_OFS:			equ	COVID_BOSS_5_SPRITE_INICIAL-8
COVID_BOSS_5_SPRITES_ACTIVOS_CANT:			equ	COVID_BOSS_5_CANTIDAD
...
.PINTA_MAGIAS_BOSS_5:
	...
	ld		a,2
	call	.PINTA_MAGIAS_BOSS_5_EN_PAGE
	ld		a,3

.PINTA_MAGIAS_BOSS_5_EN_PAGE:

	push	af
	call	.RECARGA_DATOS_MAGIA_BOSS_5
	pop		af
	ld		(ix+7),a
	push	af
	ld		a,(MAGIAS)
...
.CALCULA_DECENAS_MAGIA_BOSS_5:

	cp		10
	jr		c,.DIGITOS_MAGIA_LISTOS_BOSS_5
	sub		10
	inc		b
	jr		.CALCULA_DECENAS_MAGIA_BOSS_5

.DIGITOS_MAGIA_LISTOS_BOSS_5:

	ld		(VARIABLE_UN_USO),a
	ld		a,b

.NORMALIZA_DECENAS_MAGIA_BOSS_5:

	cp		10
	jr		c,.DECENA_MAGIA_NORMALIZADA_BOSS_5
	sub		10
	jr		.NORMALIZA_DECENAS_MAGIA_BOSS_5

.DECENA_MAGIA_NORMALIZADA_BOSS_5:

	call	.CALCULA_ORIGEN_DIGITO_MAGIA_BOSS_5
	ld		(ix),a
	ld		(ix+4),115
...
.RECARGA_DATOS_MAGIA_BOSS_5:

	ld		hl,BOSS_5_COPY_PUNTOS_MAGIA
...
.CALCULA_ORIGEN_DIGITO_MAGIA_BOSS_5:
...
.OCULTA_SPRITES_COVID_INICIALES_BOSS_5:
		...
		ld		hl,SPRITES_ACTIVOS+COVID_BOSS_5_SPRITES_ACTIVOS_OFS
		ld		b,COVID_BOSS_5_SPRITES_ACTIVOS_CANT
		ld		a,1

.RESERVA_SPRITES_ACTIVOS_COVID_BOSS_5:

		ld		(hl),a
		inc		hl
		djnz	.RESERVA_SPRITES_ACTIVOS_COVID_BOSS_5
		ret
...
PINTA_MARCADORES_VIDA_FINAL_BOSS_5:
        ...
        cp      93
        jr      nc,.ULTIMOS_6_PIXELES_BARRA_BOSS_5
...
.FIN_REDONDEA_BARRA_A_6_BOSS_5:
        ...
        jr      .ANCHO_BARRA_BOSS_5_OK

.ULTIMOS_6_PIXELES_BARRA_BOSS_5:
...
MATA_TODOS_LOS_COVIDS_POR_MAGIA_BOSS_5:

		ld		b,COVID_BOSS_5_CANTIDAD
		xor		a
		ld		(COVID_BOSS_5_INDICE_ACTUAL),a

.BUCLE_MATA_COVIDS_POR_MAGIA_BOSS_5:

		push	bc
		call	OBTIENE_PUNTERO_ACTIVO_COVID_BOSS_5_ACTUAL
		ld		a,(hl)
		or		a
		call	nz,MATA_COVID_BOSS_5_ACTUAL_CON_EXPLOSION
		ld		a,(COVID_BOSS_5_INDICE_ACTUAL)
		inc		a
		ld		(COVID_BOSS_5_INDICE_ACTUAL),a
		pop		bc
		djnz	.BUCLE_MATA_COVIDS_POR_MAGIA_BOSS_5
		ret
...
PREPARA_PAGE_2_PARA_MAGIA_BOSS_5:

		ld		a,(SET_PAGE)
		cp		3
		ret		nz
		ld		hl,BOSS_5_PAGE_3_A_PAGE_2_COMPLETA
		call	DOCOPY
		call	VDPREADY
		ld		a,2
		ld		(SET_PAGE),a
...
RESTAURA_PAGE_3_TRAS_MAGIA_BOSS_5:
...
PINTA_MAGIAS_BOSS_5:		equ	RUTINA_BOSS_5.PINTA_MAGIAS_BOSS_5
