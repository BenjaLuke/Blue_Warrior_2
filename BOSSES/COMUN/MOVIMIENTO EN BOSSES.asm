...
.PULSA_M:
	...
	IFNDEF MOVIMIENTO_SIN_REFRESCO_MAGIAS_BOSSES
	call	.REFRESCA_MAGIAS_BOSS
	ENDIF
...
.PULSA_BOTON_2:
	...
	IFNDEF MOVIMIENTO_SIN_REFRESCO_MAGIAS_BOSSES
	call	.REFRESCA_MAGIAS_BOSS
	jr	.FIN_RUTINA_GLOBAL

.REFRESCA_MAGIAS_BOSS:

	ld	a,(PAGINA_DE_REGRESO)
	cp	26
	jr	z,.REFRESCA_MAGIAS_BOSS_1
	cp	27
	jr	z,.REFRESCA_MAGIAS_BOSS_2
	cp	28
	jr	z,.REFRESCA_MAGIAS_BOSS_3
	cp	29
	jr	z,.REFRESCA_MAGIAS_BOSS_4
	cp	30
	ret	nz
	jp	PINTA_MAGIAS_BOSS_5

.REFRESCA_MAGIAS_BOSS_2:

	ld	a,(MAGIAS)
	ld	(VARIABLE_UN_USO2),a
	jp	PAGE44_A_SEGMENT_1_PINTA_MAGIAS_ROCK

.REFRESCA_MAGIAS_BOSS_3:

	jp	PINTA_MAGIAS_BOSS_3

.REFRESCA_MAGIAS_BOSS_4:

	jp	PINTA_MAGIAS_BOSS_4

.REFRESCA_MAGIAS_BOSS_1:

	jp	PINTA_MAGIAS_BOSS_1
	ENDIF
