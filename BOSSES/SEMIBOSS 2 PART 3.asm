...
SPRITES_TEMPORALES_ATR_BASE_PART3_SEMIBOSS_2			equ		#4A00+16*4
...
SPRITES_ALPHONSERRYX_DESTINO_PART3_SEMIBOSS_2		        equ		#4000+54*8*4
SPRITES_ALPHONSERRYX_TAM_PART3_SEMIBOSS_2			equ		4*8*4
SPRITES_COVID_DESTINO_PART3_SEMIBOSS_2				equ		#4000+62*8*4
