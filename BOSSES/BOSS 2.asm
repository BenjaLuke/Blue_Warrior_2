VIDA_INICIAL_ROCKAGER_BOSS_2:			equ	20
...
PROYECTIL_BOSS_2_SPRITE_FINAL:			equ	28
PROYECTIL_BOSS_2_Y_OCULTO:				equ	217
PROYECTIL_BOSS_2_SPRITES_ACTIVOS_OFS:	equ	14
...
ROCAS_ROCKAGER_SPRITES_ACTIVOS_OFS_BOSS_2:	equ	10
ROCAS_ROCKAGER_SPRITES_ACTIVOS_CANT_BOSS_2:	equ	4
...
DAVEANIX_LIMPIA_SPRITE_INICIAL_BOSS_2:	equ	8
DAVEANIX_LIMPIA_SPRITES_CANT_BOSS_2:	equ	24
...
.VARIABLES:
		...
		call	RESERVA_SPRITES_ACTIVOS_ROCAS_ROCKAGER_BOSS_2
...
.CONTROL_POST_BUCLE_2:
		...
		call	BUCLE_REVISION_TODOS_LOS_PROYECTILES_OJO_BOSS_2
		jp	BUCLE_PELEA_BOSS_2
...
RESERVA_SPRITES_ACTIVOS_ROCAS_ROCKAGER_BOSS_2:

		ld		hl,SPRITES_ACTIVOS+ROCAS_ROCKAGER_SPRITES_ACTIVOS_OFS_BOSS_2
		ld		b,ROCAS_ROCKAGER_SPRITES_ACTIVOS_CANT_BOSS_2
		ld		a,1

.BUCLE_RESERVA_SPRITES_ROCAS_ROCKAGER_BOSS_2:

		ld		(hl),a
		inc		hl
		djnz	.BUCLE_RESERVA_SPRITES_ROCAS_ROCKAGER_BOSS_2
		ret
...
[2]	add	a
	...
	ld	a,(ix+3)
	cp	25
	jr	c,.ROCA_ACTIVA_EN_COLISION
	cp	27
	jr	nz,.SIGUIENTE_EN_EL_BUCLE

.ROCA_ACTIVA_EN_COLISION:
...
PINTA_MARCADORES_VIDA_FINAL_BOSS_2:
        ...
        cp      93
        jr      nc,.ULTIMOS_6_PIXELES_BARRA_BOSS_2
...
.FIN_REDONDEA_BARRA_A_6_BOSS_2:
        ...
        jr      .ANCHO_BARRA_BOSS_2_OK

.ULTIMOS_6_PIXELES_BARRA_BOSS_2:
