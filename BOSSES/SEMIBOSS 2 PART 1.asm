...
.continua:
        ...
        call    LIMPIA_ATRIBUTOS_SPRITES_ROCKAGER
...
.COPI_MARCADOR_BOSSES_CORAZONES_VACIOS:
	...
	dw	#0000+151,#0000+220,#0000+151,#0203,#0000+99,#000C
	db      #00,#00,11000000b
...
MOVIMIENTO_DEPH_EN_ROCKAGER:
        ...
        ld      a,PAGINA_REGRESO_SEMIBOSS_2
        ld      (PAGINA_DE_REGRESO),a
        DEFINE  MOVIMIENTO_SIN_REFRESCO_MAGIAS_BOSSES
