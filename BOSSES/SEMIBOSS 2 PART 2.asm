...
SPRITES_PIEDRA_ORIGEN_PART2_SEMIBOSS_2				equ		SPRITES_PIEDRA
SPRITES_PIEDRA_DESTINO_PART2_SEMIBOSS_2				equ		VRAM_SPRITES_PATRONES_PART2_SEMIBOSS_2+60*8*4
SPRITES_PIEDRA_TAM_PART2_SEMIBOSS_2					equ		4*8*4
...
.restamos_vida_a_rockagers:
	...
	call	CALCULA_DANO_MAGIA_ROCKAGER_PART2_SEMIBOSS_2
	ld		c,a
...
CALCULA_DANO_MAGIA_ROCKAGER_PART2_SEMIBOSS_2:
	...
	ld		e,a
	ld		d,0
	ld		hl,TABLA_DANO_MAGIA_ROCKAGER_PART2_SEMIBOSS_2
	add		hl,de
	ld		a,(hl)
	ret

TABLA_DANO_MAGIA_ROCKAGER_PART2_SEMIBOSS_2:

	db		6,9,12,6,6,9,9,12,15
...
.VOLCAMOS_SPRITES_PIEDRA_ROCKAGER:

	ld		hl,SPRITES_PIEDRA
	ld		de,VRAM_SPRITES_PATRONES_PART2_SEMIBOSS_2+60*8*4
	ld		bc,4*8*4
	call    PAGE_32_A_SEGMENT_2
	call	PON_COLOR_2.sin_bc_impuesta
	call    PAGE_10_A_SEGMENT_2
