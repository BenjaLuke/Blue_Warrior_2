...
CHUMINIX_PELEA_PASO_X_SEC_1_BOSS_3:			equ	4
CHUMINIX_PELEA_PASO_Y_SEC_1_BOSS_3:			equ	2
CHUMINIX_PELEA_PASO_X_SEC_2_BOSS_3:			equ	16
CHUMINIX_PELEA_PASO_Y_SEC_2_BOSS_3:			equ	1
...
CHUMINIX_PELEA_DURACION_SEC_1_MIN_BOSS_3:	equ	50		; 1 segundos a 50 Hz
CHUMINIX_PELEA_DURACION_SEC_1_RANGO_BOSS_3:	equ	101		; +0..100 -> 2 a 4 segundos
CHUMINIX_PELEA_DURACION_SEC_2_BOSS_3:		equ	25		; medio segundo a 50 Hz
...
;
; Horizontal:
;   X crece   -> rellena X-delta, Y, ancho delta, alto 48
;   X decrece -> rellena X+128,   Y, ancho delta, alto 48
;
; Vertical:
;   Y crece   -> rellena X menor, Y-delta, ancho 128+deltaX, alto delta
;   Y decrece -> rellena X menor, Y+48,    ancho 128+deltaX, alto delta
;   Asi cubrimos el rastro cuando Chuminix se mueve en diagonal.
; -----------------------------------------------------------------------------
...
; Rectangulo: X nueva + 128, Y nueva, ancho delta, alto 48.
...
; Rectangulo: X anterior, Y nueva, ancho delta, alto 48.

		ld		c,a				; C = X anterior temporal
		ld		a,b
		sub		c
		ld		d,a				; D = ancho / delta X
		ld		b,c				; B = X destino del relleno
		ld		a,(CHUMINIX_BOSS_3_ESPERA_MOVIMIENTO)
		ld		c,a				; C = Y destino del relleno
		ld		e,CHUMINIX_APARICION_ALTO_BOSS_3
		jp		PINTA_RECTANGULO_COLOR_3_CHUMINIX_BOSS_3
...
; Rectangulo: X menor entre anterior/nueva, Y nueva + 48,
; ancho 128 + delta X, alto delta Y.
		...
		ld		c,a				; C = Y destino del relleno
		call	CALCULA_X_Y_ANCHO_RASTRO_CHUMINIX_BOSS_3
		jp		PINTA_RECTANGULO_COLOR_3_CHUMINIX_BOSS_3

.Y_CRECE_CHUMINIX_PELEA_BOSS_3:

; Y crece: delta = Y nueva - Y anterior.
; Rectangulo: X menor entre anterior/nueva, Y anterior,
; ancho 128 + delta X, alto delta Y.
...
; Calcula la X y el ancho para los rectangulos de rastro vertical.
; Cuando Chuminix se mueve en diagonal, el barrido de Y debe cubrir
; desde la X menor hasta el final derecho de la posicion mas a la derecha.
;
; Salida:
;   B = min(X anterior, X nueva)
;   D = 128 + abs(X nueva - X anterior)
; Conserva:
;   C = Y destino
;   E = alto

CALCULA_X_Y_ANCHO_RASTRO_CHUMINIX_BOSS_3:
