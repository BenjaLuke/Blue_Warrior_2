...
EXPLOSION_ERRECENYX_SPRITE_BOSS_4:			equ	17
EXPLOSION_ERRECENYX_Y_OCULTA_BOSS_4:			equ	212
EXPLOSION_ERRECENYX_ATRIBUTOS_VRAM_BOSS_4:	equ	SPRITES_ATRIBUTOS_VRAM_BOSS_4+EXPLOSION_ERRECENYX_SPRITE_BOSS_4*4
...
BARROS_MUERTE_Y_OCULTA_BOSS_4:				equ	212
...
PROYECTIL_BOSS_4_SPRITE_FINAL:				equ	28
PROYECTIL_BOSS_4_Y_OCULTO:					equ	212
PROYECTIL_BOSS_4_SPRITES_ACTIVOS_OFS:		equ	14
...
COVID_BOSS_4_SPRITES_ACTIVOS_OFS:			equ	COVID_BOSS_4_SPRITE_INICIAL-8
COVID_BOSS_4_SPRITES_ACTIVOS_CANT:			equ	COVID_BOSS_4_CANTIDAD
...
ERRECENYX_LIMPIA_SPRITE_INICIAL_BOSS_4:		equ	8
ERRECENYX_LIMPIA_SPRITES_CANT_BOSS_4:			equ	24
...
DEPH_LODO_PATRON_CANT_BOSS_4:			equ	12
DEPH_LODO_COLOR_INICIO_BOSS_4:			equ	4
DEPH_LODO_COLOR_CANT_BOSS_4:			equ	4
...
.VARIABLES:
		...
		call	OCULTA_EXPLOSION_ERRECENYX_BOSS_4
		ld		a,VIDA_INICIAL_ERRECENYX_BOSS_4
		ld		(VIDA_ERRECENYX_BOSS_4),a
		ld		a,255
		ld		(ERRECENYX_BOSS_4_X),a
		ld		(ERRECENYX_BOSS_4_X_PAGE_2),a
		ld		(ERRECENYX_BOSS_4_X_PAGE_3),a
		ld		a,3
		ld		(ERRECENYX_BOSS_4_PAGE_PINTA),a
		xor		a
		ld		(ERRECENYX_BOSS_4_ANCHO_PAGE_2),a
		ld		(ERRECENYX_BOSS_4_ANCHO_PAGE_3),a
		ld		(ERRECENYX_BOSS_4_X_VISIBLE),a
		ld		(ERRECENYX_BOSS_4_ANCHO_VISIBLE),a
...
.PINTA_MAGIAS_REALES:
	...
	call	.PINTA_MAGIAS_BOSS_4

.PREPARACION_PELEA:

	ld		hl,BOSS_4_PAGE_2_A_PAGE_3_COMPLETA
	call	DOCOPY
	call	VDPREADY
...
.PINTA_MAGIAS_BOSS_4:
	...
	ld		a,2
	call	.PINTA_MAGIAS_BOSS_4_EN_PAGE
	ld		a,3

.PINTA_MAGIAS_BOSS_4_EN_PAGE:

	push	af
	call	.RECARGA_DATOS_MAGIA_BOSS_4
	pop		af
	ld		(ix+7),a
	push	af
	ld		a,(MAGIAS)
...
.CALCULA_DECENAS_MAGIA_BOSS_4:

	cp		10
	jr		c,.DIGITOS_MAGIA_LISTOS_BOSS_4
	sub		10
	inc		b
	jr		.CALCULA_DECENAS_MAGIA_BOSS_4

.DIGITOS_MAGIA_LISTOS_BOSS_4:

	ld		(VARIABLE_UN_USO),a
	ld		a,b

.NORMALIZA_DECENAS_MAGIA_BOSS_4:

	cp		10
	jr		c,.DECENA_MAGIA_NORMALIZADA_BOSS_4
	sub		10
	jr		.NORMALIZA_DECENAS_MAGIA_BOSS_4

.DECENA_MAGIA_NORMALIZADA_BOSS_4:

	call	.CALCULA_ORIGEN_DIGITO_MAGIA_BOSS_4
	ld		(ix),a
	ld		(ix+4),115
...
.RECARGA_DATOS_MAGIA_BOSS_4:

	ld		hl,BOSS_4_COPY_PUNTOS_MAGIA
...
.CALCULA_ORIGEN_DIGITO_MAGIA_BOSS_4:
...
.CORAZONES_MAXIMOS_DEPH_OK:
	...
	ld		ix,BOSS_4_CUADRO_CORAZONES_FUERA_MAX_STATUS
	call	.PINTA_CUADRO_CORAZONES_FUERA_MAX

	ld		ix,BOSS_4_CUADRO_CORAZONES_FUERA_MAX_EMPTY
	call	.PINTA_CUADRO_CORAZONES_FUERA_MAX
	ret
...
.OCULTA_SPRITES_COVID_INICIALES_BOSS_4:
		...
		ld		hl,SPRITES_ACTIVOS+COVID_BOSS_4_SPRITES_ACTIVOS_OFS
		ld		b,COVID_BOSS_4_SPRITES_ACTIVOS_CANT
		ld		a,1

.RESERVA_SPRITES_ACTIVOS_COVID_BOSS_4:

		ld		(hl),a
		inc		hl
		djnz	.RESERVA_SPRITES_ACTIVOS_COVID_BOSS_4
		ret
...
COMPRUEBA_LIMITES_PROYECTIL_BOSS_4:
		...
		ld		a,(hl)
		cp		5
		jr		c,DESACTIVA_PROYECTIL_BOSS_4
		cp		192
		jr		nc,DESACTIVA_PROYECTIL_BOSS_4
...
PINTA_UN_PROYECTIL_BOSS_4:
		...
		or		a
		ret		z
		jr		CARGA_ATRIBUTOS_PROYECTIL_BOSS_4
...
MUEVE_ERRECENYX_BOSS_4:
		...
		dec		a
		ld		(ERRECENYX_BOSS_4_ESPERA_MOVIMIENTO),a
		jr		nz,.FIN_MOVIMIENTO_ERRECENYX
...
PINTA_ERRECENYX_BOSS_4:
		...
		call	BORRA_ERRECENYX_EN_PAGE_OCULTA_BOSS_4
		call	CALCULA_RECORTE_ERRECENYX_BOSS_4
		...
		ld		a,(VARIABLE_UN_USO2)
		or		a
		jp		z,FINALIZA_PINTA_ERRECENYX_BOSS_4

		ld		a,(ERRECENYX_BOSS_4_FOTOGRAMA)
		cp		8
		jr		z,PINTA_ERRECENYX_FOTOGRAMA_PARTIDO_BOSS_4
		...
		jp		FINALIZA_PINTA_ERRECENYX_BOSS_4
...
.ANCHO_IZQUIERDA_OK_ERRECENYX_BOSS_4:
		...
		ld		a,(VARIABLE_UN_USO2)
		sub		c
		jr		z,FINALIZA_PINTA_ERRECENYX_BOSS_4
...
.PINTA_PARTE_DERECHA_ERRECENYX_BOSS_4:
		...
		ld		(iy+2),a
		call	COPY_ERRECENYX_ACTUAL_BOSS_4
		jr		FINALIZA_PINTA_ERRECENYX_BOSS_4
...
PREPARA_COPY_ERRECENYX_BOSS_4:
		...
		xor		a
		ld		(iy+5),a
		ld		a,(ERRECENYX_BOSS_4_PAGE_PINTA)
		ld		(iy+7),a
		ld		a,(VARIABLE_UN_USO2)
		ld		(iy+8),a
		ret
...
FINALIZA_PINTA_ERRECENYX_BOSS_4:

		call	GUARDA_POSICION_ERRECENYX_EN_PAGE_BOSS_4
		ld		a,(ERRECENYX_BOSS_4_PAGE_PINTA)
		ld		(SET_PAGE),a
		jr		ALTERNA_PAGE_PINTA_ERRECENYX_BOSS_4

GUARDA_POSICION_ERRECENYX_EN_PAGE_BOSS_4:

		ld		a,(ERRECENYX_BOSS_4_PAGE_PINTA)
		cp		2
		jr		z,.GUARDA_X_PAGE_2_ERRECENYX_BOSS_4

		ld		a,(ERRECENYX_BOSS_4_X_VISIBLE)
		ld		(ERRECENYX_BOSS_4_X_PAGE_3),a
		ld		a,(ERRECENYX_BOSS_4_ANCHO_VISIBLE)
		ld		(ERRECENYX_BOSS_4_ANCHO_PAGE_3),a
		ret

.GUARDA_X_PAGE_2_ERRECENYX_BOSS_4:
...
ALTERNA_PAGE_PINTA_ERRECENYX_BOSS_4:

		ld		a,(ERRECENYX_BOSS_4_PAGE_PINTA)
		cp		2
		jr		z,.PASA_A_PAGE_3_ERRECENYX_BOSS_4

		ld		a,2
		ld		(ERRECENYX_BOSS_4_PAGE_PINTA),a
		ret

.PASA_A_PAGE_3_ERRECENYX_BOSS_4:

		ld		a,3
		ld		(ERRECENYX_BOSS_4_PAGE_PINTA),a
		ret

BORRA_ERRECENYX_EN_PAGE_OCULTA_BOSS_4:
		...
		ld		a,(ERRECENYX_BOSS_4_PAGE_PINTA)
		cp		2
		jr		z,.LEE_X_PAGE_2_ERRECENYX_BOSS_4

		ld		a,(ERRECENYX_BOSS_4_X_PAGE_3)
		ld		(VARIABLE_UN_USO),a
		ld		a,(ERRECENYX_BOSS_4_ANCHO_PAGE_3)
		jr		.COMPRUEBA_X_BORRA_ERRECENYX_BOSS_4

.LEE_X_PAGE_2_ERRECENYX_BOSS_4:

		ld		a,(ERRECENYX_BOSS_4_X_PAGE_2)
		ld		(VARIABLE_UN_USO),a
		ld		a,(ERRECENYX_BOSS_4_ANCHO_PAGE_2)

.COMPRUEBA_X_BORRA_ERRECENYX_BOSS_4:

		or		a
		jr		z,.FIN_BORRA_ERRECENYX_EN_PAGE_OCULTA_BOSS_4
		ld		(VARIABLE_UN_USO2),a
		ld		a,(VARIABLE_UN_USO)
		cp		255
		jr		z,.FIN_BORRA_ERRECENYX_EN_PAGE_OCULTA_BOSS_4
		...
		xor		a
		ld		(iy+9),a
		ld		a,ERRECENYX_MOVIMIENTO_ALTO_BOSS_4
		ld		(iy+10),a
		xor		a
		ld		(iy+11),a
		ld		hl,DATAS_COPY_RECUP_SCROLL
...
.FIN_BORRA_ERRECENYX_EN_PAGE_OCULTA_BOSS_4:
...
MUERTE_DEPH_EN_BOSS_4:
	...
	call	ASEGURA_PAGE_2_VISIBLE_BOSS_4
...
MATA_TODOS_LOS_COVIDS_POR_MAGIA_BOSS_4:

		ld		b,COVID_BOSS_4_CANTIDAD
		xor		a
		ld		(COVID_BOSS_4_INDICE_ACTUAL),a

.BUCLE_MATA_COVIDS_POR_MAGIA_BOSS_4:

		push	bc
		call	OBTIENE_PUNTERO_ACTIVO_COVID_BOSS_4_ACTUAL
		ld		a,(hl)
		or		a
		call	nz,MATA_COVID_BOSS_4_ACTUAL_CON_EXPLOSION
		ld		a,(COVID_BOSS_4_INDICE_ACTUAL)
		inc		a
		ld		(COVID_BOSS_4_INDICE_ACTUAL),a
		pop		bc
		djnz	.BUCLE_MATA_COVIDS_POR_MAGIA_BOSS_4
		ret
...
MATA_COVID_BOSS_4_ACTUAL_CON_EXPLOSION:
		...
		ld		de,#4800+EXPLOSION_ERRECENYX_SPRITE_BOSS_4*16
...
PINTA_EXPLOSION_ERRECENYX_BOSS_4:
		...
		xor		a
		ld		(ix+2),a
		jr		OCULTA_EXPLOSION_ERRECENYX_BOSS_4

.PINTAMOS_EXPLOSION_ERRECENYX_BOSS_4:

		ld		de,EXPLOSION_ERRECENYX_ATRIBUTOS_VRAM_BOSS_4
...
OCULTA_EXPLOSION_ERRECENYX_BOSS_4:

		ld		de,EXPLOSION_ERRECENYX_ATRIBUTOS_VRAM_BOSS_4
		ld		hl,SPRITE_EXPLOSION_ERRECENYX_OCULTO_BOSS_4
		ld		bc,4
		jp		PON_COLOR_2.sin_bc_impuesta
...
ASEGURA_PAGE_2_VISIBLE_BOSS_4:

		ld		a,(ERRECENYX_BOSS_4_PAGE_PINTA)
		cp		2
		jr		nz,.PAGE_2_YA_VISIBLE_BOSS_4

		call	PINTA_ERRECENYX_BOSS_4

.PAGE_2_YA_VISIBLE_BOSS_4:
...
PREPARA_PAGE_2_PARA_MAGIA_BOSS_4:

		ld		a,(SET_PAGE)
		cp		3
		ret		nz
		ld		hl,BOSS_4_PAGE_3_A_PAGE_2_COMPLETA
		call	DOCOPY
		call	VDPREADY
		ld		a,2
		ld		(SET_PAGE),a
...
RESTAURA_PAGE_3_TRAS_MAGIA_BOSS_4:
...
PINTA_MAGIAS_BOSS_4:		equ	RUTINA_BOSS_4.PINTA_MAGIAS_BOSS_4
