...
FOTOGRAMAS:
        ...
        dw      256,#1B4,128,096,256,018
        db      #00,#00,10010000b

        dw      256,#1A2,128,096,256,018
        db      #00,#00,10010000b

        dw      256,#190,128,096,256,018
        db      #00,#00,10010000b

        dw      256,#17E,128,096,256,018
        db      #00,#00,10010000b

        dw      256,#16C,128,096,256,018
        db      #00,#00,10010000b

        dw      256,#15A,128,096,256,018
        db      #00,#00,10010000b

        dw      256,#148,128,096,256,018
        db      #00,#00,10010000b

        dw      256,#136,128,096,256,018
        db      #00,#00,10010000b

        dw      256,#124,128,096,256,018
        db      #00,#00,10010000b

        dw      256,#112,128,096,256,018
        db      #00,#00,10010000b

        dw      256,#100,128,096,256,018
        db      #00,#00,10010000b


        dw      0,#1B4,128,096,256,018
        db      #00,#00,10010000b

        dw      0,#1A2,128,096,256,018
        db      #00,#00,10010000b

        dw      0,#190,128,096,256,018
        db      #00,#00,10010000b

        dw      0,#17E,128,096,256,018
        db      #00,#00,10010000b

        dw      0,#16C,128,096,256,018
        db      #00,#00,10010000b

        dw      0,#15A,128,096,256,018
        db      #00,#00,10010000b

        dw      0,#148,128,096,256,018
        db      #00,#00,10010000b

        dw      0,#136,128,096,256,018
        db      #00,#00,10010000b

        dw      0,#124,128,096,256,018
        db      #00,#00,10010000b

        dw      0,#112,128,096,256,018
        db      #00,#00,10010000b

        dw      0,#100,128,096,256,018
        db      #00,#00,10010000b
