...
CINEMATICA_FINAL_LETRA_ESPACIO               equ     CINEMATICA_FINAL_LETRA_ESPECIAL_BASE+16
...
TEXTO_CREDITO_005:	db		"STORY - LEVEL DESIGN",0
...
TEXTO_CREDITO_011:	db		"PROGRAMMING - SPRITES - GAME WRITER",0
